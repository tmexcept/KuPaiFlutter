...
//   final response = await http.get(Uri.parse("https://api.51kupai.com/kupai/feed/v3_list"),
//       headers: initHeaders());
...
//   final response = await http.post(Uri.parse("https://api.51kupai.com/kupai/feed/v3_list"), headers: headers, body: headers);
...
// //  headers.addAll(initHeaders());
//   final response = await http.post(Uri.parse("https://api.51kupai.com/kupai/feed/class/tag/recommend"), headers: initHeaders(), body: headers);
...
//   final response = await http.get(Uri.parse("https://bkapi.51kupai.com/app/tips/queryTips"));
//
...
//   final response = await http.post(Uri.parse("https://api.51kupai.com/kupai/feed/getClassConfigListByType"), body: headers);
//
